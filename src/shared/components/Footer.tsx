        ...
        <div className="site-footer__inner">
          ...
          <div className="wrap" aria-label="푸터">
            ...
            <div className="info_wrap">
              <div>
                <span>(주)위드마인드 | 대표: 주민성 | 사업자등록번호: 794-87-00687 | 통신판매업신고번호: 제 2021-대전유성-0522호 | 직업정보제공사업 신고번호: J1302020260002</span>
              </div>
              <div>
                <span>본사: 부산시 강서구 미음산단5로 41번길 71 부산글로벌테크비즈센터 4층 405-A1호</span>
