...
export const NAVER_REDIRECT_URI = "http://localhost:5174/auth/oauth/naver/callback";
...
//export const KAKAO_REDIRECT_URI = "http://localhost:5174";
export const KAKAO_REDIRECT_URI = "http://localhost:5174/auth/oauth/kakao/callback";