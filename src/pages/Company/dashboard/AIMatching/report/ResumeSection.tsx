...
const data1 = {
  ...
  aiAnalysis: {
    items: [
      {
        title: "1. 기술적 적합성",
        desc: "위위님 후보자는 Figma와 Google Analytics를 활용한 사용자 중심 기획 경험이 풍부하며, 데이터 기반 의사결정을 통해 전환율을 15% 향상시킨 구체적인 성과가 있습니다. 이는 우리 팀의 UX/UI 개선 프로젝트에 즉시 기여할 수 있는 핵심 역량입니다.",
      },
      {
        title: "2. 경험과 성과",
  ...
  portfolios: [
    { kind: "file" as const, name: "위위_기획포트폴리오.pdf" },
    { kind: "link" as const, url: "https://portfolio.jeongyuri.com" },
  ],
  selfIntro:
    "2년 8개월차 웹 기획자 위위입니다. 사용자 중심의 서비스 설계와 데이터 기반 의사결정에 강점이 있습니다. Figma를 활용한 프로토타이핑과 GA를 통한 사용자 행동 분석 경험을 바탕으로, 실질적인 비즈니스 성과를 만들어내는 기획자로 성장하고 있습니다.",
  mockInterview: {
    title: "92점ㆍ웹 기획자ㆍ25.01.15 [성장하는 기획자 위위입니다.]",
  },
};
