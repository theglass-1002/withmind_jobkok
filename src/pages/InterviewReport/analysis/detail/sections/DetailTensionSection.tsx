...
export default function DetailTensionSection({
 ...
 return (
    <div
      className={`analysis-section detail-analysis__attitude ${className ?? ""}`}
    >
      ...
      <div className="analysis-section__body">
        <TensionLevelGraph reportDetail={reportDetail} />
        <TensionContent className={className} reportDetail={reportDetail} />
      </div>
    </div>
  );
}