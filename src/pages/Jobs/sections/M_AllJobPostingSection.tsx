...
export default function M_AllJobPostingSection() {
  ...
  const makeChipsFromFilters = (filters: AppliedFilters) => {
    ...
    if (isCareerSelected && careerChipText) {
      next.push({
        id: `career:${min}-${max}`,
        group: "경력",
        role: careerChipText,
        ...
        <div className="jobs-toolbar__search">
          ...
          <div className="job-search-filters">
            ...
            <ul className="job-search-filter-menu">
              <li
                className={`job-search-filter-menu__item ${openFilter === 'role' ? 'is-open' : ''} ${roleCount > 0 ? 'selected' : ''}`}
              ...
              <li
                className={`job-search-filter-menu__item ${openFilter === 'career' ? 'is-open' : ''} ${careerSelected ? 'selected' : ''}`}
              ...
              <li
                className={`job-search-filter-menu__item ${openFilter === 'education' ? 'is-open' : ''} ${educationCount > 0 ? 'selected' : ''}`}
              ...
              <li
                className={`job-search-filter-menu__item ${openFilter === 'location' ? 'is-open' : ''} ${locationCount > 0 ? 'selected' : ''}`}
              ...
              <li
                className={`job-search-filter-menu__item ${openFilter === 'employment' ? 'is-open' : ''} ${employmentCount > 0 ? 'selected' : ''}`}
