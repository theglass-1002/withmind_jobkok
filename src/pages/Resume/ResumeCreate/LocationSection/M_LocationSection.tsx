...
import {District,Region,LocationSectionProps} from '@/shared/utils/util';
...
export default function M_LocationSection({ 
  ...
  return (
    <div  id="resume__create-section--location" className="resume-create-page__section resume-create-page__section--location">
      ...
      <div className="resume-create-page__location">
        ...
        <div className="location-picker__chip"><div className="location-picker__chip-body"><span className="location-picker__chip-group">서울</span><span className="location-picker__chip-role"><span className="location-picker__chip-chevron">
        <img src={chevron_right_black} alt="" />
        </span>강동구</span></div><span className="location-picker__chip-close" role="button" aria-label="선택 해제">
