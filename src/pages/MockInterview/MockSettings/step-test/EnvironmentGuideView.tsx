...
export default function EnvironmentGuideView() {
  return (
    <div className="mock-environment-page">
      ...
      <div className="env-guide__content-wrapper">
          ...
          <div className="env-guide__item env-guide__item--visual">
            <div className="env-guide__text-group">
              <span className="env-guide__item-title">
                ...
                자세를 바르게 해 주세요.</span>
              <span className="env-guide__item-desc">가이드라인에 얼굴 전체가 들어오도록 해 주세요.</span>
            </div>
          ...
          <div className="env-guide__item env-guide__item--audio">
            <div className="env-guide__text-group">
              ...
              <span className='env-guide__item-number'>02</span>
                적절한 크기의 목소리로 말해주세요.</span>
              <span className="env-guide__item-desc">조용한 장소에서 테스트를 진행해 주세요.</span>
            </div>
            <div className="env-guide__image-box">
        ...
        <button className="env-guide__start-btn">환경 테스트 시작하기</button>
      </div>
  </div>
  )
}
