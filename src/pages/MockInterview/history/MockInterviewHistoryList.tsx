...
export type MockInterviewHistoryItemData = {
  id: string | number;
  no: string | number;
  avatarSrc: string;
  scoreText: string;
...
interface MockInterviewHistoryListProps {
  sortIconSrc: string;
  viewIconSrc: string;
  items: MockInterviewHistoryItemData[];
...
export default function MockInterviewHistoryList({
  sortIconSrc,
  viewIconSrc,
  items,
  page,
